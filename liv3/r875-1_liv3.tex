...
l'efficacité des passages fauniques adaptés aTux\\
...
\vfill
\noindent
\includegraphics[width=4cm]{logos/logo_ulaval.pdf}\hfill\includegraphics[width=4cm]{logos/logo_mtmd.png}
...
\include{sections/goals_I}
\include{sections/method_I}
\include{sections/result_I}
\include{sections/discussion_I}
%\include{sections/conclusion_I}
\part{Critères de connectivité écologique – Région métropolitaine de Montréal}
\include{sections/goals_II}
\include{sections/method_II}
\include{sections/result_II}
\include{sections/discussion_II}
\include{sections/conclusion_II}
