...
\subsection{Mortalité et suivis de la petite faune}
\addM{Seuls les données des pièges-photographiques sont présentées dans la prochaine section. Les résultats des autres suivis réalisés en 2024, notamment les décomptes de mortalité, les enregistrements accoustiques, la recherche par drones et les refuges à reptiles, figuraient dans le rapport d'étape de 2025 et ne sont pas présentés ici.}
